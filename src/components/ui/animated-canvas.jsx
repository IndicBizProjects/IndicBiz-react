...
export const AnimatedCanvas = ({
  count = 40,
  lineColor = '#8d9f70', // IndicBiz Olive
  ...
  useEffect(() => {
    ...
    // Set canvas size
    const resizeCanvas = () => {
      // Use parent container size instead of full window to ensure it fits the hero properly
  ...
  return <canvas ref={canvasRef} className={className} style={{ display: 'block', width: '100%', height: '100%', pointerEvents: 'none' }} />;
};
