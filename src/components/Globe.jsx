...
export default function Globe({
  className = "",
  size = 480,
  dotColor = "rgba(141, 159, 112, ALPHA)",
  arcColor = "rgba(141, 159, 112, 0.5)",
  markerColor = "rgba(141, 200, 120, 1)",
  ...
  const draw = useCallback(() => {
    ...
    glowGrad.addColorStop(0, "rgba(141, 159, 112, 0.05)");
    glowGrad.addColorStop(1, "rgba(141, 159, 112, 0)");
    ...
    ctx.strokeStyle = "rgba(141, 159, 112, 0.12)";
    ctx.lineWidth = 1;
    ctx.stroke();
