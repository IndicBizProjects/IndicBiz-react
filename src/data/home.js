...
export const EXAMPLE_ENGAGEMENTS = [
  {
    ...
    outcome: 'Clearer content hierarchy, easier publishing and faster discovery.',
    palette: 'forest',
  },
  {
    title: 'Operations dashboard',
    category: 'Product design',
    outcome: 'Complex workflows organised into calm, actionable interfaces.',
    palette: 'sand',
  },
  {
    title: 'Hospitality launch',
    category: 'Brand identity',
    outcome: 'A warm identity and digital presence built around a distinct story.',
    palette: 'clay',
  },
]
